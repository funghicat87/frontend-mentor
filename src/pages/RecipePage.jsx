...
const RecipePage = () => {
  return (
    <div className='w-full bg-Eggshell flex items-center justify-center py-20'>
      <div className='bg-White w-[1000px] rounded-3xl p-12'>
        <img src={omeletteImage} alt="Omelette" className='rounded-2xl' />
        <div className='font-serif mt-12 text-[3.5rem] text-stone-800'>
        ...
        <div className='rounded-2xl p-8 mt-7 bg-RoseWhite'>
          ...
          <div>
            {preparation.map((ele, index) => (
              <li key={ele.index} className='text-xl text-stone-500 mt-3'>
            ...
            <div className='divide-y-2 divide-slate-200 mt-3 '>
              {
                nutrition.map((ele, index) => (
                  <li className='list-none text-xl text-stone-500 flex py-3' key={ele.index}>
